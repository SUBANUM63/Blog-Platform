#!/usr/bin/python
"""
This module defines the database models for the BlogPost application.
...
Imports:
    ...
    - login_manager: Login manager instance from the BlogPost application.
...
class User(db.Model, UserMixin):
    ...
    Attributes:
        ...
        posts (list): List of posts associated with the user.
    """
...
class Post(db.Model):
    """
    Post model for storing post-related information.
